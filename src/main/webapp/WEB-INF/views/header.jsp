        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <li class="nav-item">
                        <a class="py-2" href="http://localhost:8189/products" aria-label="Product">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                 ...
                                 class="d-block mx-auto" role="img" viewBox="0 0 24 24"><title>Product</title>
                ...
                <form class="d-flex " id="navLoginSubmit">
                    ...
                    <button id="logIn" class="btn btn-outline-success mt-2" type="submit"
                            style="margin-left: 10px;white-space: nowrap">
                        <fmt:message key="label.LogIn"/>
                    </button>
                    <button id="regButton" class="btn btn-outline-success mt-2"
                            style="margin-left: 10px; white-space: nowrap"
                            type="submit"><fmt:message key="label.SignUp"/>
                    </button>
                </form>
            </div>
        </div>
