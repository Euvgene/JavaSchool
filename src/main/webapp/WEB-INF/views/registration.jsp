    ...
    <main style="">
        ...
        <div class="row g-5" style="justify-content: center">
            <div class="col-md-8 col-lg-8" style="justify-content: center">
                <h4 class="mb-3" style="margin-top: 100px;"><fmt:message key="label.registration"/></h4>
                <form  id="form" >
                    <div class="row g-3">
                        <div class="col-sm-3">
                            <label for="firstName" class="form-label"><fmt:message key="label.firstName"/></label>
                            <input type="text"  class="form-control" id="firstName" placeholder="<fmt:message key="label.firstName"/>"  name="firstname">
                        </div>
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="button" id="checkout"><fmt:message key="label.checkout"/></button>
                </form>
                <div id="errorMassage" >
                </div>
            </div>
